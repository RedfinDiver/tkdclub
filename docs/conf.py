# -*- coding: utf-8 -*-
#
# TKDClub documentation build configuration file, created by
# sphinx-quickstart on Sun Feb 19 20:11:41 2017.
#
...
project = u'TKDClub - Joomla! Extension'
copyright = u'2017, Markus Moser'
author = u'Markus Moser'
...
latex_documents = [
    (master_doc, 'TKDClub.tex', u'TKDClub Documentation',
     u'Markus Moser', 'manual'),
]
...
man_pages = [
    (master_doc, 'tkdclub', u'TKDClub Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TKDClub', u'TKDClub Documentation',
     author, 'TKDClub', 'One line description of project.',
     'Miscellaneous'),
]
