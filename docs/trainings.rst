...
Neu erstellte Trainings werden als "unbezahlt" markiert. Die noch zu zahlenden
Aufwandsentschädigungen werden in der Statistik ausgewiesen.

Sind Trainings ausbezahlt, so können diese als bezahlt werden. Dafür gibt es 2
Möglichkeiten:

- In der Listansicht **mehrere Einträge** markieren und mit dem Button
  "bezahlt" die gewählten Einträge als bezahlt markieren.

- In der Editiersicht eines **einzelnen Eintrag** im Feld
  "Trainerentschädigung" den Eintrag auf "bezahlt" stellen.
...
hier öffnet sich das Formular zum Bearbeiten des Trainings. Gelöscht können
