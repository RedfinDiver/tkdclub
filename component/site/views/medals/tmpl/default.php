...
JHtml::stylesheet('/components/com_tkdclub/assets/css/tkdclub.css');

$helper = new TkdClubHelperMembers;
?>

<div class="tkdclub">
    <h2><?php echo JText::_('COM_TKDCLUB_MEDAL') . ' ' .JComponentHelper::getParams('com_tkdclub')->get('club_name', JText::_('COM_TKDCLUB')); ?></h2>
    <div class="row-fluid">
...
<table class="table table-hover">
    <thead class="">
        <tr>
            <th class=""><?php echo JText::_('COM_TKDCLUB_DATE'); ?></th>
            <th style="text-align:left"><?php echo JText::_('COM_TKDCLUB_MEDAL_CHAMPIONSSHIP'); ?></th>
            <th style="text-align:left"><?php echo JText::_('COM_TKDCLUB_MEDAL_CHAMPIONSSHIP_TYPE'); ?></th>
            <th style="text-align:left"><?php echo JText::_('COM_TKDCLUB_MEDAL_CLASS'); ?></th>
            <th class=""><?php echo JText::_('COM_TKDCLUB_MEDAL_PLACING'); ?></th>
            <th style="text-align:left"><?php echo JText::_('COM_TKDCLUB_ATHLETS'); ?></th>
        </tr>
    </thead>
    <tbody>
