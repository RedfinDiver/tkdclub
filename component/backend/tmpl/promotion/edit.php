...
<form action="<?php echo Route::_('index.php?option=com_tkdclub&promotion_id=' . (int) $this->item->promotion_id); ?>" method="post" name="adminForm" id="promotion-form" class="form-validate">
    ...
    <div>
        <?php echo HtmlHelper::_('uitab.startTabSet', 'myTab', array('active' => 'promotion')); ?>
            <?php echo HtmlHelper::_('uitab.addTab', 'myTab', 'promotions', empty($this->item->promotion_id) ? Text::_('COM_TKDCLUB_PROMOTION_NEW_TAB', true) : Text::sprintf('COM_TKDCLUB_PROMOTION_EDIT', $this->item->promotion_id, true)); ?>
            <div class="row">
                    <div class="col-lg-6">
