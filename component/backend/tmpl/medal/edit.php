...
<form action="<?php echo Route::_('index.php?option=com_tkdclub&medal_id=' . (int) $this->item->medal_id); ?>" method="post" name="adminForm" id="medal-form" class="form-validate">
    ...
    <div>
        <?php echo HtmlHelper::_('uitab.startTabSet', 'myTab', array('active' => 'medal')); ?>
            <?php echo HtmlHelper::_('uitab.addTab', 'myTab', 'medals', empty($this->item->medal_id) ? Text::_('COM_TKDCLUB_MEDAL_NEW_TAB', true) : Text::sprintf('COM_TKDCLUB_MEDAL_EDIT', $this->item->medal_id, true)); ?>
                <div class="row">
                    <div class="col-lg-6">
