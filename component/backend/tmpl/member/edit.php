...
<form action="<?php echo Route::_('index.php?option=com_tkdclub&member_id=' . (int) $this->item->member_id); ?>" method="post" name="adminForm" id="member-form" class="form-validate" enctype="multipart/form-data">   
    ...
    <div>
        <?php echo HtmlHelper::_('uitab.startTabSet', 'myTab', array('active' => 'personal')); ?>
            ...
            <?php echo HtmlHelper::_('uitab.addTab', 'myTab', 'personal', empty($this->item->member_id) ? Text::_('COM_TKDCLUB_MEMBER_NEW_TAB', true) : Text::_('COM_TKDCLUB_MEMBER_EDIT', true)); ?>
            <div class="row">
                <div class="col-lg-3">
