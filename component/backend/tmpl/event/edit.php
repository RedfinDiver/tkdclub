...
<form action="<?php echo Route::_('index.php?option=com_tkdclub&event_id=' . (int) $this->item->event_id); ?>" method="post" name="adminForm" id="event-form" class="form-validate">
    <div>
        <?php echo HtmlHelper::_('uitab.startTabSet', 'myTab', array('active' => 'personal')); ?>
                <?php echo HtmlHelper::_('uitab.addTab', 'myTab', 'event', empty($this->item->event_id) ? Text::_('COM_TKDCLUB_EVENT_NEW_TAB', true) : Text::_('COM_TKDCLUB_EVENT_EDIT_TAB', true)); ?>
                <div class="row">
                    <div class="col-lg-6">
