...
$wa->getRegistry();
$wa->useScript('com_tkdclub.iban')->useScript('com_tkdclub.members-format-iban');
                                ...
                                <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <th scope="row" class="">
                                        <div>
                                            ...
                                            <?php endif; ?>
                                            <?php if ($canEdit) : ?>
                                                <a href="<?php echo Route::_("index.php?option=com_tkdclub&task=member.edit&member_id=" . (int) $item->member_id); ?>">
