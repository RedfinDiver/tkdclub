...
{   
    ...
    */
    ...
    public function getItem($pk = null)
    {
        ...
        {      
            ...
            $query
                ...
                ->join('inner', $db->quoteName('#__tkdclub_candidates', 'b') .' ON (' . $db->quoteName('b.id_candidate') . ' = ' . $db->quoteName('a.member_id') . ')')
    ...
    public function getCandidateData($candidate_id, $promotion_id)
    {
        ...
        $query
            ->select('a.member_id, a.firstname, a.lastname, a.grade, a.lastpromotion, a.birthdate, a.entry')
            ->from($db->quoteName('#__tkdclub_members', 'a'))
            ...
            ->where('a.member_id = '. (int) $candidate_id);
