                ...
                <?php foreach ($this->items as $i => $item) : ?>
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="title center">
                            ...
                            echo '<a href="'.$mylink.'">'.JHtml::_('date', $item->date, JText::_('DATE_FORMAT_LC4'))
                                    . ' '.'('. $this->escape($item->city).')'.'</a>';
                            ?>
                        </td>
                        <?php $type = array('kup' => JText::_('COM_TKDCLUB_PROMOTION_KUP'), 'dan' => JText::_('COM_TKDCLUB_PROMOTION_DAN')) ?>
