...
JText::script('COM_TKDCLUB_STATISTICS_STATE_ALL_MEMBERS_IN_DB');
JText::script('COM_TKDCLUB_STATISTICS_GENDER_DIST');
JText::script('COM_TKDCLUB_STATISTICS_AGE_DIST');
